...
export default function AgreementPage() {
  ...
  const handleSignContract = async () => {
    ...
    setTimeout(() => {
      ...
      // Save progress and update loan status
      const loanProgress = {
        currentStep: 'completed',
        completedSteps: ['terms', 'enach', 'agreement'],
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="p-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h4 className="font-medium text-blue-900 mb-2">Important Terms to Review</h4>
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Loan amount and repayment schedule</li>
                <li>• Interest rates and applicable fees</li>
                <li>• Late payment penalties and charges</li>
                <li>• Prepayment terms and conditions</li>
                <li>• Default conditions and consequences</li>
