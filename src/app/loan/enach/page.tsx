...
export default function EnachSetupPage() {
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-black mb-2">Review & Authenticate Mandate</h1>
              <div className="mt-2 text-sm text-gray-500">
                Application ID: <span className="font-mono">LOAN001</span>
              </div>
            </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
            <h2 className="text-lg font-semibold text-black mb-4">Mandate Details</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-black">As and When Presented</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-green-600 font-semibold">₹ 50,000</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Purpose</label>
                <p className="text-sm text-black">Small value mandate</p>
              </div>
              <div>
